...
import 'package:bazar/dropshipping/approved_vendorlist.dart';
...
class DropshippingHome extends StatefulWidget {
  const DropshippingHome({super.key});

  @override
  State<DropshippingHome> createState() => _DropshippingHomeState();
}

class _DropshippingHomeState extends State<DropshippingHome> {
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Approved_Vendorlist(),
                        ),
                      );
                    },
                    child: Padding(
      ...
      child: ListView(
        ...
        children: [
          UserAccountsDrawerHeader(
            ...
            accountName: const Text('Reseller Name'),
            accountEmail: const Text('Reseller@example.com'),
