...
import '../providers/vendor_productR.dart';
...
class Vendor_requestedProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: vendorProductsR.products.isEmpty
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton.icon(
                                onPressed: () {
                                  _showEditDialog(
                                      context, product, vendorProductsR);
                                },
                                icon: const Icon(
                                  Icons.edit,
                                  color: Colors.white,
                              ...
                              ElevatedButton.icon(
                                onPressed: () {
                                  vendorProductsR.acceptProduct(product['id']);
                                },
                                icon: const Icon(
                                  Icons.check,
                                  color: Colors.white,
                              ...
                              ElevatedButton.icon(
                                onPressed: () {
                                  vendorProductsR.declineProduct(product['id']);
                                },
                                icon: const Icon(
                                  Icons.close,
                                  color: Colors.white,
